...
type Grib2InternalType = G2UInt1Type | G2UInt2Type | G2Int2Type | G2UInt4Type | G2Int4Type | G2UInt8Type;
...
function isInternalType<T>(obj: Grib2InternalType | Grib2TemplateEnumeration<T>) : obj is Grib2InternalType {
    return obj === 'ui1' || obj === 'ui2' || obj == 'i2' || obj === 'ui4' || obj === 'i4' || obj === 'ui8';
}
...
export {Grib2Struct, Grib2TemplateEnumeration, unpackStruct, unpackUTF8String, unpackerFactory, G2UInt1, G2UInt2, G2Int2, G2UInt4, G2Int4, G2UInt8};
