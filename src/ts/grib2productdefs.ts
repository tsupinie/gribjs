import { Constructor, G2Int1, G2Int4, G2UInt1, G2UInt2, G2UInt4, Grib2Struct, Grib2TemplateEnumeration, InternalTypeMapper, unpackerFactory } from "./grib2base";
...
const g2_ens_forecast_at_time_types = {
    ...
    forecast_time: G2UInt4,
    fixed_surface_1_type: G2UInt1,
    fixed_surface_1_scale_factor: G2Int1,
    fixed_surface_1_value: G2Int4,
    fixed_surface_2_type: G2UInt1,
    fixed_surface_2_scale_factor: G2Int1,
    fixed_surface_2_value: G2Int4,
