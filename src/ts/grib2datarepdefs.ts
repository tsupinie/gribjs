...
class Grib2SimplePacking extends Grib2Struct<InternalTypeMapper<typeof g2_simple_packing_types>> {};
...
class Grib2PNGPacking extends Grib2Struct<InternalTypeMapper<typeof g2_png_packing_types>> {};
